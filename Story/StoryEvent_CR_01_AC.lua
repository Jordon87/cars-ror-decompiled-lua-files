...
function L1_1()
  local L0_2, L1_2
  L0_2 = DebugPrint
  L1_2 = "onUnlocked(StoryEvent_CR_01_BR01)"
  L0_2(L1_2)
end
...
function L1_1()
  ...
  L0_2(L1_2)
  L0_2 = DebugPrint
  L1_2 = "unlocked bumper 03, side 03 and spoiler 03"
  L0_2(L1_2)
end
