...
function L1_1()
  local L0_2, L1_2
  L0_2 = DebugPrint
  L1_2 = "onUnlocked(StoryEvent_CR_01_BR02)"
  L0_2(L1_2)
end
...
function L1_1()
  ...
  L0_2(L1_2)
  L0_2 = DebugPrint
  L1_2 = "unlocked bumper05, hood06 and side05"
  L0_2(L1_2)
end
