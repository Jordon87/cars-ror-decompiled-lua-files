...
function L1_1()
  local L0_2, L1_2
  L0_2 = DebugPrint
  L1_2 = "onUnlocked(StoryEvent_CR_05_AC)"
  L0_2(L1_2)
end
...
function L1_1()
  ...
  L0_2(L1_2)
  L0_2 = DebugPrint
  L1_2 = "unlocked bumper14, side14 and spoiler16"
  L0_2(L1_2)
end
