...
function L1_1()
  local L0_2, L1_2
  L0_2 = DebugPrint
  L1_2 = "onUnlocked(StoryEvent_CR_04_AC)"
  L0_2(L1_2)
end
...
function L1_1()
  ...
  L0_2(L1_2)
  L0_2 = DebugPrint
  L1_2 = "unlocked bumper11, hood12, side11 and spoiler12"
  L0_2(L1_2)
end
