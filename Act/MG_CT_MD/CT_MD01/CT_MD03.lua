...
CT_MD03 = {
  ...
  EventHandler = function(_ARG_0_, _ARG_1_)
    if _ARG_1_ == "StateChange_Intro" then
      MaterdorMinigame:ApplySettings(_ARG_0_.Rounds)
    end
  ...
  MediumSettings = {
    TripleChargeDuration = 6,
    TripleChargeDodgeWindow = {1.5, 2.5},
    {
      AngerBoostPerTaunt = 25,
      TauntInputTimeout = 6,
      TractorChargeDuration = 3,
      TractorChargeDodgePromptTime = 1,
      MediumThreshold = 100,
